...
export async function POST(
  ...
  try {
    ...
    const signatureString = `POST/api/v1/printify-orders/${printifyOrderId}/bind-scm-order${timestamp}${nonce}${tenantName}${bodyString}`;
    ...
    // 构建后端URL
    const backendUrl = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/v1/printify-orders/${printifyOrderId}/bind-scm-order`;
