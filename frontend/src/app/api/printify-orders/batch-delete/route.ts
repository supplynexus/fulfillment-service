...
const logger = createLogger('api.printify-orders.batch-delete');
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.info('🔍 批量删除请求', {
      ...
      count: requestBody.order_ids?.length || 0,
    });
    ...
    const backendPath = '/api/v1/printify/orders/batch-delete';
    ...
    logger.info('📡 调用后端 Printify 批量删除 API', {
