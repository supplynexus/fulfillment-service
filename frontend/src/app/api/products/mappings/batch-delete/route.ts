...
const logger = createLogger('api.product-mappings.batch-delete');
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const backendPath = '/api/v1/products/mappings/batch-delete';
    ...
    logger.info('Forwarding batch-delete to backend', { backendEndpoint: backendUrl });
    ...
    if (!backendResponse.ok) {
      ...
      logger.error('Backend batch-delete failed', {
