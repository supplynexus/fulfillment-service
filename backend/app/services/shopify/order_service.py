...
class ShopifyOrderService:
    ...
    def _convert_shopify_order_to_schema(self, order_data: Dict[str, Any]) -> OrderCreate:
        ...
        for item in order_data.get('lineItems', {}).get('edges', []):
            ...
            line_items.append({
                ...
                'price': node.get('originalUnitPriceSet', {}).get('shopMoney', {}).get('amount'),
                'currency': node.get('originalUnitPriceSet', {}).get('shopMoney', {}).get('currencyCode')
            })
