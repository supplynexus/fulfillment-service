...
class SCMOrder(Base):
    ...
    target_system_type = Column(String, nullable=False)  # printify, custom_fulfillment, warehouse
...
class RoutingRule(Base):
    ...
    # Routing conditions
    conditions = Column(JSON, nullable=False)  # Product types, quantities, regions, etc.
